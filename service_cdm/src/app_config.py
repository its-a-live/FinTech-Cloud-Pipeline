...
class AppConfig:
    ...
    def __init__(self) -> None:
        ...
        self.kafka_port = str(os.getenv('KAFKA_PORT') or "")
        ...
        self.kafka_consumer_topic = str(os.getenv('KAFKA_DESTINATION_TOPIC') or "")
        ...
        self.pg_warehouse_sslmode = str(os.getenv('PG_WAREHOUSE_SSLMODE') or "require")
